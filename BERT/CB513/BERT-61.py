...
np.save('/content/drive/MyDrive/prot_bert_bfd_cb513/bertprot-cb513-window-61-val.npy', predict)

predict = predictor.predict_proba(f_X_test)
predict = np.array(predict)
np.save('/content/drive/MyDrive/prot_bert_bfd_cb513/bertprot-cb513-window-61-test.npy', predict)