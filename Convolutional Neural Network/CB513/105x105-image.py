...
for idx in tqdm(range(1, 5279)):
  img, labels = dados(52, idx-1, idx)
  img = np.reshape(img, (-1, 105, 105, 1))
...
train_gen = datagen.flow_from_dataframe(
      ...
      target_size=(105, 105), class_mode='categorical', batch_size=32, shuffle=True, seed=42)

val_gen = datagen.flow_from_dataframe(
      df_val, directory='/content/CB513/Val', x_col='Id', y_col='Target',
      target_size=(105, 105), class_mode='categorical', batch_size=32, shuffle=False, seed=42)
...
# generate the model
cnn = tf.keras.applications.EfficientNetB7(weights='imagenet', include_top=False, input_shape=(105,105,3))
...
mc = tf.keras.callbacks.ModelCheckpoint('/content/drive/MyDrive/PSSM/CB513/EfficientNetB7-105x105x3.hdf5', monitor='val_loss', save_best_only=True, verbose=1)
...
np.save('/content/drive/MyDrive/PSSM/CB513/pred_efficientnetb7/105x105x3-val.npy', pred)

# test
pred = model.predict(test_gen, batch_size=32, verbose=1)
np.save('/content/drive/MyDrive/PSSM/CB513/pred_efficientnetb7/105x105x3-test.npy', pred)