...
mc = tf.keras.callbacks.ModelCheckpoint('/content/drive/MyDrive/PSSM/CB6133/EfficientNetB7-147x147x3.hdf5', monitor='val_loss', save_best_only=True, verbose=1)
...
np.save('/content/drive/MyDrive/PSSM/CB6133/pred_efficientnetb7/147x147x3-val.npy', pred)

# test
pred = model.predict(test_gen, batch_size=32, verbose=1)
np.save('/content/drive/MyDrive/PSSM/CB6133/pred_efficientnetb7/147x147x3-test.npy', pred)